    ...
    <div className="app-bg flex h-screen w-screen flex-col overflow-hidden">
      <header className="glass-header z-20 flex h-[60px] shrink-0 items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-3">
          <div className="flex size-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-[0_4px_16px_rgba(99,102,241,0.4)]">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-indigo-500/20 px-2.5 py-0.5 text-[9px] font-bold tracking-wider text-indigo-700 dark:text-indigo-300 border border-indigo-500/30">
                AI OFFICE
              </span>
            </div>
        ...
        <div className="flex items-center gap-2.5">
          <div className="hidden items-center gap-3 rounded-full border border-slate-300 dark:border-white/10 bg-white/80 dark:bg-slate-900/60 px-3.5 py-1.5 shadow-sm backdrop-blur-xl md:flex">
        ...
        <div className="grid h-full min-h-0 flex-1 grid-cols-1 md:grid-cols-[1fr_440px] gap-3">
          ...
          <div className="glass-panel relative flex h-full min-h-0 flex-col overflow-hidden rounded-2xl">
            ...
            <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-hidden p-3">
              ...
              <div className="h-px shrink-0 bg-gradient-to-r from-transparent via-slate-300 dark:via-white/10 to-transparent" />
